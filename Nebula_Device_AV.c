        ...
        while (find_nal_unit(p, sz, &nal_start, &nal_end) > 0) {
            ...
            switch (h->nal->nal_unit_type) {
                case NAL_UNIT_TYPE_CODED_SLICE_NON_IDR:
                    printf("NAL_UNIT_TYPE_CODED_SLICE_NON_IDR\n");
//                    memset(fname_buf, 0, 1024);
//                    sprintf(fname_buf, "file.%d", cnt);
//                    outfile_misc = fopen(fname_buf, "wb");
...
//                    cnt += 1;
                ...
                case NAL_UNIT_TYPE_CODED_SLICE_IDR:
                    printf("NAL_UNIT_TYPE_CODED_SLICE_IDR\n");
//                    total_byte += nal_end;
//                    memset(fname_buf, 0, 1024);
//                    sprintf(fname_buf, "file.%d", cnt);
//                    outfile_misc = fopen(fname_buf, "wb");
//                    fwrite(head, 1, total_byte, outfile_misc);
//                    fclose(outfile_misc);
//                    cnt += 1;
                    nalu = head;
